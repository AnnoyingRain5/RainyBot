...
class Translator(commands.Cog):
    ...
    @discord.slash_command(name = "create_channel_group")
    #adding a default value makes parameter optional
    async def create_channel_group(self, ctx, channel1, channel1language, channel1webhook, channel2, channel2language, channel2webhook,
    ...
    @discord.slash_command()
    async def removechannelgroup(self, ctx, channelgroupid: int):
        if channelgroupid == 0:
